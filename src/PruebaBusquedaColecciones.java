...
public class PruebaBusquedaColecciones {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		int index = Collections.binarySearch(alumnos, new Alumno("Alv", null, 0));
		index = Collections.binarySearch(alumnos, new Alumno("ALV", null, 0));
		System.out.println("	Buscando a alv...\n");
		if(index >=0) 
